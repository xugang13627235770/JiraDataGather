...
import com.citms.modules.sys.oauth2.TokenGenerator;
...
public class SysUserTokenServiceImpl extends ServiceImpl<SysUserTokenDao, SysUserTokenEntity> implements
																							  SysUserTokenService {
	@Value("${citms.jwt.expire}")
	private Integer expire;
	//12小时后过期
	private final static int EXPIRE = 3600 * 24 * 2;
